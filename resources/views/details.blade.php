...
<head>
    ...
    <style>
        ...
        *,*::before,*::after { box-sizing:border-box; margin:0; padding:0 }
        ...
        .related-h { font-size:clamp(0.875rem, 1.8vw, 1.25rem); font-weight:300; letter-spacing:.4em; text-transform:uppercase; text-align:center; color:var(--primary); margin-bottom:2.5rem }
        ...
        .f-social { display:flex; align-items:start; gap:1rem }
        .f-icon {
...
<body x-data="{ openModal: null }">
    ...
    {{-- WhatsApp FAB --}}
    <a href="https://wa.me/6282260600099?text=Halo%20Farhana,%20saya%20tertarik%20dengan%20produk%20{{ urlencode($product->name) }}"
                    ...
                    <form action="{{ route('cart.add', $product->id) }}" method="POST" id="cartForm" novalidate>
                        ...
                        <div class="btn-row" id="btnRow">
                            <button type="button" class="btn btn-outline" id="btnCart" onclick="handleOrder('add')">
                                {{ $product->is_preorder ? 'Pre-Order Sekarang' : 'add to cart' }}
                            </button>
    ...
    <footer id="about" role="contentinfo"
        ...
        <div class="footer-inner">
            ...
            <div>
                ...
                <div>
                    <h4 class="f-title text-left">Follow Us</h4>
<div class="f-social flex flex-col items-start gap-4 mt-4">
    
    <!-- Instagram -->
    <div class="flex items-center gap-3">
        <a href="https://www.instagram.com/farhanas.id" class="f-icon" target="_blank" rel="noopener">
        ...
        <span class="f-handle text-[10px] uppercase tracking-[0.2em]">@farhanas.id</span>
    </div>

    <!-- TikTok -->
    <div class="flex items-center gap-3">
        <a href="https://www.tiktok.com/@farhanas.id" class="f-icon" target="_blank" rel="noopener">
            <svg class="w-8 h-8 fill-current" viewBox="0 0 24 24">
                <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.17-2.86-.6-4.12-1.31a8.52 8.52 0 0 1-1.87-1.43v6.24c-.03 2.34-.79 4.7-2.6 6.13-1.81 1.43-4.39 1.83-6.57 1.15-2.18-.68-4.05-2.48-4.66-4.67-.61-2.19-.19-4.78 1.25-6.58 1.44-1.8 3.84-2.74 6.11-2.43.01.01.01.01.02.02v4.16c-1.13-.19-2.36.03-3.23.82-.87.79-1.2 2.06-.85 3.19.35 1.13 1.43 1.99 2.61 2.08 1.18.09 2.4-.42 3.01-1.43.25-.42.36-.91.36-1.4V0z"/>
            </svg>
        </a>
        <span class="f-handle text-[10px] uppercase tracking-[0.2em]">@farhanas.id</span>
    </div>
